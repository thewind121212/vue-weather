...
<template>
    <div class="w-auto fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1001] rounded-2xl pt-2 flex-col gap-4 select-none invisible opacity-0"
        id="forcast-today-hr">
        <HeaderHr :day="day" :hr="hr" :timeZone="timeZone" />
        <div class="grid w-full grid-flow-col grid-rows-1 gap-4 overflow-hidden rounded-2xl">
